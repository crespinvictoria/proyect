...
let mainLi = document.getElementsByClassName("main_li");
let mainP = document.getElementsByClassName("li_p");
...
darkModeButton.addEventListener("click", function(){
    ...
    servicios.classList.toggle("darkModeFooterText");
    
    for (let i = 0; i < mainLi.length; i++) {
    mainLi[i].classList.toggle("darkModeHeaderA");
    }

    for (let i = 0; i < mainP.length; i++) {
    mainP[i].classList.toggle("darkModeHeaderA");
    }
